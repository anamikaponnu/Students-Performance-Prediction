...
The primary objective of this project is to build a reliable model that can classify student performance into pass or fail categories. In addition to prediction, the project focuses on comparing different machine learning models and identifying students who require additional academic support. 
